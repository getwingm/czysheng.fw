...
<?php Resource::registerAdmin([
        ...
        '/basic/plugins/tinyscrollbar/jquery.tinyscrollbar.js',
...
<?php Resource::registerAdmin([
        '/basic/js/jquery-1.7.2.min.js',
        '/basic/plugins/placeholder/jquery.placeholder.js',
        '/basic/plugins/validate/jquery.validate.min.js',
        '/basic/js/core/dandelion.login.js',
