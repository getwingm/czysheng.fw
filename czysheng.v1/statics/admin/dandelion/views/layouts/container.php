...
<head>
    ...
    <?php Resource::registerAdmin('/basic/js/jquery-1.7.2.min.js');?>
                        ...
                        <div id="da-logo">
                            <div id="da-logo-img">
                                <a href="<?php echo LuLu::getAlias('@web').'/admin.php';?>">
                                    <img src="<?php echo Resource::getAdminUrl()?>/basic/images/logo.png" alt="Dandelion Admin" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="da-header-toolbar" class="clearfix">
                        <div id="da-user-profile">
                            <div id="da-user-avatar">
                                <img src="<?php echo Resource::getAdminUrl()?>/basic/images/pp.jpg" alt="" />
                            </div>
                            <div id="da-user-info">
