...
(function($) {
	$(document).ready(function(e) {
        ...
        /* Main navigation on mobile */
        $("div#da-menu-nav").bind('click', function(e) {
            e.stopPropagation();
        });

        $("div#da-menubar-container").bind('click', function(e) {
            $('#da-menu-nav', $(this)).slideToggle('normal', function() {
        ...
        /* Dropdown Navigation */
        $("div#da-menu-nav ul li a").bind("click", function(e) {
            if($(this).next("ul").size() !== 0) {
                $(this).next("ul").slideToggle("normal", function() {
                    //$(this).toggleClass("closed");
                    //$(this).removeAttr("style");
                    $(this).removeAttr("style").toggleClass('closed');
                });
                e.preventDefault();
            }
        });
