...
class Content extends \source\core\base\BaseActiveRecord
{
    ...
    public function getUrl()
    {
        ...
        return Url::to(['/'.$this->content_type.'/'.$ctrlid.'/detail','id'=>$this->id]);
    }
    ...
    {
        return $this->hasOne(ContentPost::className(),['content_id'=>'id']);
    }

    public function getPage()
    {
        return $this->hasOne(ContentPage::className(),['content_id'=>'id']);
    }
