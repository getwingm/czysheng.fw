...
class ActionColumn extends \yii\grid\ActionColumn
{
    ...
    protected function initDefaultButtons()
    {
        if (! isset($this->buttons['view']))
        {
            ...
            {
                return Html::a('<img src="'.Resource::getAdminUrl().'/basic/images/icons/color/magnifier.png">', $url, [
        ...
        if (! isset($this->buttons['update']))
        {
            ...
            {
                return Html::a('<img src="'.Resource::getAdminUrl().'/basic/images/icons/color/pencil.png">', $url, [
        ...
        if (! isset($this->buttons['delete']))
        {
            ...
            {
                return Html::a('<img src="'.Resource::getAdminUrl().'/basic/images/icons/color/cross.png">', $url, [
