...
abstract class BaseContentController extends FrontController
{
	...
	public function actionList($taxonomy=-1)
	{
	    ...
	    if($taxonomy!==-1)
	    {
            $ids = $this->taxonomyService->getTaxonomyIDsAsTree($this->content_type, $taxonomy);
            $ids[] = intval($taxonomy);
	        $query->andFilterWhere(['taxonomy_id'=>$ids]);
	    }
	...
	public function actionDetail($id)
	{
        ...
        $locals['detail_id'] = $id;
        $locals['content_type'] = $this->content_type;
